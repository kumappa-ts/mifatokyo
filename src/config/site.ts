...
export const siteConfig = {
  ...
  pages: {
    ...
    imageConverter: {
      ...
      label: '画像変換ツール',
      title: '画像変換ツール',
      description: '画像の形式変換、リサイズ、フィルター適用、回転・反転が可能な、画像変換ツールです。PNG、JPG、WebP、新進気鋭のAVIFにも対応しています。',
      inNav: false,
      order: 7,
    },
    CodeFormatter: {
      ...
      label: 'コード整形ツール',
      title: 'コード整形ツール',
      description: '圧縮されたコードやインデントが乱れたコードを綺麗に整える、コード整形ツールです。HTML、CSS、JavaScriptなどのコードを見やすく整形します。',
      inNav: false,
      order: 7,
    },
  },
