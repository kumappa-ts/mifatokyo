            ...
            <div className="space-y-6">
              ...
              {showAdvanced && (
                <div className="space-y-6 border-t pt-6">
                  <div>
                    <h3 className="text-sm font-semibold text-gray-900 mb-3">リサイズ</h3>
                      ...
                      <div className="flex gap-4 flex-wrap">
                        <label className="flex items-center cursor-pointer">
                          <input
                            ...
                            className="mr-2"
                          />
                          <span className="text-sm">リサイズしない</span>
                        </label>
                        <label className="flex items-center cursor-pointer">
                          <input
                            type="radio"
                            ...
                            className="mr-2"
                          />
                          <span className="text-sm">パーセント指定</span>
                        </label>
                        <label className="flex items-center cursor-pointer">
                          <input
                            type="radio"
                            ...
                            className="mr-2"
                          />
                          <span className="text-sm">ピクセル指定</span>
                        </label>
                      </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex gap-4">
                            <div className="flex-1">
                              <label className="block text-sm text-gray-700 mb-1">幅 (px)</label>
                              <input
                                type="number"
                            ...
                            <div className="flex-1">
                              <label className="block text-sm text-gray-700 mb-1">高さ (px)</label>
                              <input
                                type="number"
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-gray-900 mb-3">回転・反転</h3>
                    <div className="space-y-3">
                      <div>
                        <label className="block text-sm text-gray-700 mb-2">回転: {transformOptions.rotation}°</label>
                      ...
                      <div className="flex gap-4">
                        <label className="flex items-center cursor-pointer">
                          <input
                            ...
                            className="mr-2"
                          />
                          <span className="text-sm">水平反転</span>
                        </label>
                        <label className="flex items-center cursor-pointer">
                          <input
                            type="checkbox"
                            ...
                            className="mr-2"
                          />
                          <span className="text-sm">垂直反転</span>
                        </label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-gray-900 mb-3">フィルター</h3>
                    <div className="space-y-3">
                      <div>
                        <label className="block text-sm text-gray-700 mb-1">
